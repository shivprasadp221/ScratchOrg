...
export declare type WcagVersion = '2.0' | '2.1' | undefined;
export declare const wcagLevels: string[];
export declare type WcagLevel = typeof wcagLevels[number];
export declare const priorities: readonly ["P1", "P2", "P3", ""];
export declare type Priority = typeof priorities[number];
 ...
 */
export declare type RuleMetadata = {
    priority: Priority;
    wcagSC: string;
    wcagLevel: WcagLevel;
};
 ...
 */
export declare type RuleInfo = Map<string, // Rule ID
RuleMetadata>;
/**
